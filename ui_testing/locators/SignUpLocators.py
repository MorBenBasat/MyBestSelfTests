...
class SignUpLocators:
    ...
    GENDER_RADIO_FEMALE_CHECK = By.XPATH, '/html/body/app-root/div/div/app-register/div/p-card/div/div/div[' \
                                          '2]/div/app-input-radio-field/div/div/div/div[2]/p-radiobutton/div'
